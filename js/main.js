...
(function () {
  ...
  if (resumeOpen && resumeModal) {
    ...
    resumeModal
      ...
      .forEach((el) => el.addEventListener("click", closeResume));
    ...
    resumeModal.addEventListener("keydown", (e) => {
      ...
      if (e.key !== "Tab") return;
      const f = resumeModal.querySelectorAll(
